...
const ListTasks = () => {
    ...
    const Showmoree = (task) => {
        dispatch(ShowMore(task))
    }
    ...
    return (
        <>
                ...
                <div key={Math.random()} className=' inline-flex w-fit  ameda'>
                    ...
                    <div className="  p-6 w-full   flex flex-col justify-around m-2  bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 ">
                        ...
                        <div className='w-full flex justify-between'>
                            <button onClick={() => { Showmoree(task) }} className="inline-flex items-center self-end py-2 px-3  text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Show
            ...
            <div className=' text-lg dark:text-white mx-auto my-11 '>{no}</div>
        </>
    )
}
